    ...
    return (
        <div id='about' className='mx-4 md:mx-16 bg-lime-50 shadow-lg px-4 py-12 md:p-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            ...
            <div className='space-y-3'>
                ...
                <h3 className='text-3xl font-bold'>As a <br /> <span className='text-4xl font-bold my-3 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-600 hover:to-purple-600'>Software Engineer</span></h3>
